...
- [src/agent/tools/read_file.ts:12-15](file://src/agent/tools/read_file.ts#L12-L15)
- [src/agent/tools/write_file.ts:12-16](file://src/agent/tools/write_file.ts#L12-L16)
...
- loadSkill(name)
  - 路径：[src/agent/skills.ts:91-119](file://src/agent/skills.ts#L91-L119)
- getSkillText()
  - 路径：[src/agent/skills.ts:127-138](file://src/agent/skills.ts#L127-L138)
- load_skill 工具
  - 路径：[src/agent/tools/load_skill.ts:5-33](file://src/agent/tools/load_skill.ts#L5-L33)

### 示例用法（调用路径）
- 在工具层调用
  - 路径：[src/agent/tools/load_skill.ts:5-33](file://src/agent/tools/load_skill.ts#L5-L33)
- 在 CLI 中触发
  - 路径：[src/agent/cli.ts:1-126](file://src/agent/cli.ts#L1-L126)
