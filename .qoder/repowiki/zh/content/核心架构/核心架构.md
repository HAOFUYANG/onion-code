...
SlashPanel["Slash 命令面板<br/>src/agent/ui/SlashPanel.tsx"]
end
subgraph "智能体核心"
...
- [App.tsx:1-60](file://src/agent/ui/App.tsx#L1-L60)
- [Thread.tsx:1-517](file://src/agent/ui/Thread.tsx#L1-L517)
...
- [App.tsx:17-60](file://src/agent/ui/App.tsx#L17-L60)
- [Thread.tsx:1-517](file://src/agent/ui/Thread.tsx#L1-L517)
...
## 架构总览
系统采用"LangGraph 图式执行 + assistant-ui React Ink + LangChain 工具 + SQLite 检查点"的组合架构。Agent 通过系统提示词与工具集合进行推理与行动；会话历史通过 SQLite 检查点自动续接，实现多轮对话与状态恢复；动态线程管理机制支持实时会话切换；Slash命令系统提供丰富的交互功能；适配器系统实现LangChain与assistant-ui的无缝集成。经过架构升级，系统现在专注于现代化的终端交互体验。
...
**图表来源**
- [App.tsx:18-47](file://src/agent/ui/App.tsx#L18-L47)
...
**更新** Slash命令系统得到全面重构，支持更丰富的交互功能。

```mermaid
sequenceDiagram
participant U as "用户"
participant TH as "Thread 组件"
participant SP as "SlashPanel"
participant SC as "SlashCommands"
participant SS as "Sessions"
U->>TH : 输入 "/sessions"
TH->>SP : 显示命令面板
TH->>SC : matchSlashCommands("/sessions")
SC-->>TH : 返回匹配的命令
U->>TH : 按下 Enter
TH->>SC : 执行 sessions 命令
...
**图表来源**
- [Thread.tsx:170-350](file://src/agent/ui/Thread.tsx#L170-L350)
...
- **Thread 主组件**：包含 HomePage 和 Composer 两个状态视图
- **SlashPanel 组件**：提供命令补全与选择功能
...
**图表来源**
- [App.tsx:17-60](file://src/agent/ui/App.tsx#L17-L60)
- [Thread.tsx:358-517](file://src/agent/ui/Thread.tsx#L358-L517)
- [SlashPanel.tsx:1-52](file://src/agent/ui/SlashPanel.tsx#L1-L52)
- [adapter.ts:13-84](file://src/agent/ui/adapter.ts#L13-L84)
...
- [App.tsx:40-47](file://src/agent/ui/App.tsx#L40-L47)
